...
public class ViewProduto extends javax.swing.JFrame {
    ...
    ProdutoJpaController produtoJpaController = new ProdutoJpaController(FabricaDeEntidades.getInstance().getEntityManagerFactory());
    FornecedorJpaController fornecedorJpaController = new FornecedorJpaController(FabricaDeEntidades.getInstance().getEntityManagerFactory());
    ...
    private void listarFornecedor() {
        listaFornecedor = this.fornecedorJpaController.findFornecedorEntities();
        cbFornecedores.removeAllItems();
        for (int i = 0; i < listaFornecedor.size(); i++) {
            cbFornecedores.addItem(listaFornecedor.get(i));
        }
    }
    ...
    private void excluirProduto() {
        ...
        Long codigo = (Long) tbProdutos.getValueAt(linha, 0);
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            try {
                this.produtoJpaController.destroy(codigo);
    ...
    private boolean recuperarProduto() {
        ...
        try {
            ...
            produto = this.produtoJpaController.findProduto(codigo);
            fornecedor = this.fornecedorJpaController.findFornecedor(produto.getFornecedoresCodigo());
            
            //seta os dados na interface
            this.tfCodigo.setText(String.valueOf(produto.getId()));
            this.jtfNome.setText(produto.getNome());
            this.tfValor.setText(produto.getValor().toString());
            this.tfEstoque.setText(String.valueOf(produto.getEstoque()));
            this.cbFornecedores.setSelectedItem(fornecedor);
            return true;
        } catch (Exception e) {
    ...
    private boolean alterarProduto() {
        ...
        produto.setId(Long.parseLong(this.tfCodigo.getText()));
        produto.setNome(this.jtfNome.getText());
        produto.setValor(Double.parseDouble(this.tfValor.getText()));
        fornecedor = (Fornecedor) this.cbFornecedores.getModel().getSelectedItem();
        produto.setFornecedoresCodigo(fornecedor.getId());
        produto.setEstoque(Integer.parseInt(this.tfEstoque.getText()));
    ...
    private void carregarProdutos() {
        List<Produto> listaModelProdutos = produtoJpaController.findProdutoEntities();

        DefaultTableModel modelo = (DefaultTableModel) tbProdutos.getModel();
        modelo.setNumRows(0);
        //CARREGA OS DADOS DA LISTA NA TABELA
        for (Produto p : listaModelProdutos) {
    ...
    private boolean salvarProduto() {
        ...
        this.produtoJpaController.create(produto);
