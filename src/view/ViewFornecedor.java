...
public class ViewFornecedor extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Long codigo = (Long) tbFornecedores.getValueAt(linha, 0);
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            try {
                this.fornecedorJpaController.destroy(codigo);
    ...
    private boolean alteraFornecedor() {
        ...
        fornecedor.setId(Long.parseLong(this.tfCodigo.getText()));
        fornecedor.setNome(this.tfNome.getText());
        fornecedor.setEndereco(this.tfEndereco.getText());
        fornecedor.setBairro(this.tfBairro.getText());
        fornecedor.setCidade(this.tfCidade.getText());
        fornecedor.setUf(this.tfUf.getText());
        fornecedor.setCep(this.tfCep.getText());
        fornecedor.setTelefone(this.tfTelefone.getText());

        try {
            this.fornecedorJpaController.edit(fornecedor);
    ...
    private boolean recuperarFornecedor() {
        ...
        try {
            ...
            Fornecedor fornecedor = new Fornecedor();
            fornecedor = fornecedorJpaController.findFornecedor(codigo);

            //seta os dados na interface
            this.tfCodigo.setText(String.valueOf(fornecedor.getId()));
            ...
            this.tfUf.setText(fornecedor.getUf());
    ...
    private void carregarFornecedores() {
        List<Fornecedor> listaFornecedor = this.fornecedorJpaController.findFornecedorEntities();
