...
public class ViewUsuario extends javax.swing.JFrame {
    ...
    private void jbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExcluirActionPerformed
        ...
        Long codigo = (Long) jTableUsuarios.getValueAt(linha, 0);
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            ...
            try {
                this.usuarioJpaController.destroy(codigo);
    ...
    private boolean salvarUsuario() {
        ...
        usuario.setNome(this.jtfNome.getText());
        usuario.setLogin(this.jtfLogin.getText());
    ...
    private boolean alterarUsuario() {
        Usuario usuario = new Usuario();
        usuario.setId(Long.parseLong(this.jtfCodigo.getText()));
        usuario.setNome(this.jtfNome.getText());
        usuario.setLogin(this.jtfLogin.getText());
        usuario.setSenha(new String(this.jtfSenha.getPassword()));
    ...
    private boolean recuperarUsuario() {
        ...
        //pega o codigo do usuario na linha selecionada
        Long codigo = (Long) jTableUsuarios.getValueAt(linha, 0);

        try {
            //recupera os dados do banco
            usuario = this.usuarioJpaController.findModelUsuario(codigo);
            //seta os dados na interface
            this.jtfCodigo.setText(String.valueOf(usuario.getId()));
            this.jtfNome.setText(usuario.getNome());
            this.jtfLogin.setText(usuario.getLogin());
            return true;
        } catch (Exception e) {
